...
import com.hdy.service.FileClientService;
import com.hdy.service.MessageClientService;
import com.hdy.service.UserClientService;
...
public class ChatFrame extends JFrame {
    ...
    private FileClientService fileClientService = null;         // 文件传输类
        ...
        btn_SendFile.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                if (getterId.equals("群聊")) {
                    ...
                    fileClientService.sendFileToAll(userId, txt_SendFile.getText(),
                            sendFileName, ChatFrame.this);
                } else {

                    fileClientService.sendFileToOne(userId, getterId, txt_SendFile.getText(),
                            sendFileName, ChatFrame.this);
                }
